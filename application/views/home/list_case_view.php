      ...
      <table id="example" class="table table-bordered table-striped table-hover  display">
        <thead style="background-color: #c8cfca;">
          <tr>
            ...
            <th style="width: 30%;">ผู้แจ้ง</th>
            <th style="width: 15%;">สถานะ</th>
            <th style="width: 30%;">ผู้รับเคส</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <?php if ($rs->tech_name != Null) { ?>
            <a href="" class="btn btn-success btn-xs" target="_blank"> <?php echo $rs->tech_name ?></a>
            <!-- btn btn-info btn-sm" -->
             <?php  } else {?>
             <a href="" class="btn btn-danger btn-xs" target="_blank">รอผู้รับ</a>
             <?php } ?>
            </td>
