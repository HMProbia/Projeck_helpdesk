...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php //echo $mylink;?>" class="logo">
      ...
      <span class="logo-mini"><b>IT</b>HelpDeskSystems</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>IT</b>HelpDeskSystems</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN MENU ADMIN</li>
           <li><a href="<?= site_url('admin');?>"><i class="fa fa-home"></i> <span>HOME</span></a></li>
           <li><a href="<?= site_url('jobs');?>"><i class="fa fa-print"></i> <span>JOBS</span></a></li>
           <li><a href="<?= site_url('report');?>"><i class="fa fa-line-chart"></i> <span>REPORT</span></a></li>
           <li><a href="<?= site_url('admin');?>"><i class="fa fa-address-card-o"></i> <span>USER IT</span></a></li>
          <li><a href="<?= site_url('login/logout');?>" onclick="return confirm('do you want to logout ?');"><i class="fa fa-sign-out"></i> <span>LOGOUT</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>